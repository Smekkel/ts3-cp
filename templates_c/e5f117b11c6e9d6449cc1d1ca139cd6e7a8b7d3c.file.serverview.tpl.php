<?php /* Smarty version Smarty3rc4, created on 2014-07-18 06:07:12
         compiled from "W:\home\cp.test.ru\www\ts3wi\templates/yeti/serverview.tpl" */ ?>
<?php /*%%SmartyHeaderCode:642753c88150555b90-20774134%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e5f117b11c6e9d6449cc1d1ca139cd6e7a8b7d3c' => 
    array (
      0 => 'W:\\home\\cp.test.ru\\www\\ts3wi\\templates/yeti/serverview.tpl',
      1 => 1405649231,
    ),
  ),
  'nocache_hash' => '642753c88150555b90-20774134',
  'function' => 
  array (
  ),
...
" />
                <button type="submit" style="margin-bottom: 5px;" name="start" class="start btn btn-success"><span class="glyphicon glyphicon-play"></span> <?php echo $_smarty_tpl->getVariable('lang')->value['start'];?>
</button>
                <button type="submit" style="margin-bottom: 5px;" type="submit" name="stop" class="stop btn btn-danger" onclick="return confirm('<?php echo $_smarty_tpl->getVariable('lang')->value['stopservermsg'];?>
