<?php /* Smarty version Smarty3rc4, created on 2014-10-18 13:22:31
         compiled from "W:\home\cp.test.ru\www\ts3wi\templates/bootstrap/mainbar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:165795442315748b3b6-30395303%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e5c43df901daad96d04f2e3f81f856e5e4c2a348' => 
    array (
      0 => 'W:\\home\\cp.test.ru\\www\\ts3wi\\templates/bootstrap/mainbar.tpl',
      1 => 1413624145,
    ),
  ),
  'nocache_hash' => '165795442315748b3b6-30395303',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-header">
                ...
                <?php }else{ ?>
                    <a href="index.php?site=serverview&sid=<?php echo $_smarty_tpl->getVariable('sid')->value;?>
" class="navbar-brand">DEFNOX <sup><small>cp</small></sup></a>
                <?php }?>
            </div>
...
"><?php echo $_smarty_tpl->getVariable('lang')->value['bansexport'];?>
                ...
                <ul class="nav navbar-nav navbar-right data-no-collapse="true"">
                    ...
                    <?php }?>
                    <?php if ($_smarty_tpl->getVariable('hoststatus')->value===false){?>
                     <li><a href="index.php?site=serverview&sid=<?php echo $_smarty_tpl->getVariable('sid')->value;?>
"><span class="glyphicon glyphicon-bookmark"></span> <?php echo $_smarty_tpl->getVariable('lang')->value['my-server'];?>
</a></li>
                    <?php }?>
                    <li class="dropdown">
                ...
                <div class="modal-body">
                    <div class="container-modal">
                        ...
                        <form method="post" action="index.php?site=server">
                            ...
                            <br>
                            <button type="button" class="btn btn-modal-close btn-xs btn-default" data-dismiss="modal" style="width: 80%"><?php echo $_smarty_tpl->getVariable('lang')->value['close'];?>
</button>
                        </form>
                    </div>
                    </div>
