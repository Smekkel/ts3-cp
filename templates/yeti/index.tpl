...
<link rel="stylesheet" href="templates/{$tmpl}/gfx/bootstrap.min.css" type="text/css" media="screen" />
<script type="text/javascript" src="templates/{$tmpl}/gfx/js/jquery-2.1.1.min.js"></script>
<script src="templates/{$tmpl}/gfx/js/bootstrap.min.js" type="text/javascript"></script>
