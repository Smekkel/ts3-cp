    ...
    <div class="col-md-4">
        ...
        <div class="btn-group">
            <form method="post" action="index.php?site=serverview&amp;sid={$sid}">
                ...
                <button type="submit" style="margin-bottom: 5px;" name="start" class="start btn btn-success"><span class="glyphicon glyphicon-play"></span> {$lang['start']}</button>
                <button type="submit" style="margin-bottom: 5px;" type="submit" name="stop" class="stop btn btn-danger" onclick="return confirm('{$lang['stopservermsg']}')"><span class="glyphicon glyphicon-stop"></span> {$lang['stop']}</button>
            </form>
        </div>
        </div>
